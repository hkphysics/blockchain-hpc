...
from executor import app, refund_address, decode_response
...
def test_request_example():
    ...
    assert b"<h2>Hello, World!</h2>" in response.content
...
def test_json():
    response = client.post("/api1-test",
                           ...
                           headers=headers)
    assert response.json() == {"to": "0x7c2e0e489493e487903941f399a0255c4c170c91", "tx0": "", "tx1": "0xae5f0d027177d8e016d4d507166ce563e68da73a867f100a43014006b147c6819fcb02b90000000000000000000000002abeb7afc86612a6d9a1727abc677270adc2422a"}
